@AAWO-4401
Feature: Save As From PED Tablet to PED Tablet
  ...
  #Tests As an authorized PED Formulator, I can access the Formula Module – Formula Composition page so that I will be able to click on Save As button from PED Tablet to create PED Tablet 
  @AAWO-7514 @FullAutomation @Sprint38
  Scenario: Test Save As From PED Tablet to PED Tablet
