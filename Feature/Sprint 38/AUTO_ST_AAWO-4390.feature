@AAWO-4390
Feature: Save As From Chassis to Formula-Custom WF
  ...
  #Tests as a authorized system user (Formulator/PED Formulator/RMC), I can access the Formula Module – Formula Composition page so that I will be able to click on Save As button from Chassis to create Formula-Custom WF
  @AAWO-7522 @FullAutomation @Sprint38
  Scenario Outline: Tests Save As From Chassis to Formula-Custom WF
    ...
    And The User selects "Chassis" for "Formula Type*" field on Create New Formula page
    ...
    And The User selects "EMEA" for "Chassis Region*:" field on Create New Formula page
