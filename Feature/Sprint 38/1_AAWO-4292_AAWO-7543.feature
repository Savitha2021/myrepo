...
Feature: Formula Custom Workflow - View Information under Formula WF - Completed Reviews Tab when Approval For Scale Up workflow is launched and Approvers are selected
	...
	@AAWO-7543 @FullAutomation @Sprint-38
	Scenario Outline: Test Formula Custom Workflow - View Information under Formula WF - Completed Reviews Tab when Approval For Scale Up workflow is launched and Approvers are selected 01
