...
Feature: Formula Approval For Scale Up Request (Formula Custom WF)
	...
	@AAWO-7515 @FullAutomation @Sprint-37
	Scenario Outline: Test Formula Approval For Scale Up Request (Formula Custom WF) 01
		...
		And The User verifies "Data Required" mandatory subsection on Request Approvals tab 
