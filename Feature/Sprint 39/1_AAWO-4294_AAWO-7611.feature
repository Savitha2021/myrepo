@AAWO-4294
Feature: Approval for Launch for Formula using Custom WF - Submit Workflow Button - Exception task confirmation window 
	...
	@AAWO-7611 @FullAutomation @Sprint-39
	Scenario Outline: Test Approval for Launch for Formula using Custom WF - Submit Workflow Button - Exception task confirmation window 
		...
		And The User enters values for all mandatory fields for "Approval for Launch" with Hut on Request Approvals tab
