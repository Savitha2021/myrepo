...
Feature: Formula Custom Workflow - View Information under Formula Workflow page - In Progress Tab when HUT workflow is launched
 ...
 @AAWO-7432 @FullAutomation @Sprint-39
  Scenario Outline: Test Formula Custom Workflow - View Information under Formula Workflow page - In Progress Tab when HUT workflow is launched 01
