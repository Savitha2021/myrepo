...
Feature: Formula HUT Request (Formula Custom WF) - Required Approvers Selection
  ...
  @AAWO-7632 @FullAutomation @Sprint-39
  Scenario Outline: Test Formula HUT Request (Formula Custom WF) - Required Approvers Selection 01
    ...
    And The User selects "Yes" radio button for "Unsupervised HUT for Claim Support (excluding patch tests)?*" field under "HUT" subsection on Request Approvals tab
    ...
    And The User enters all mandatory fields under "Inputs" subsection on Request Approvals tab for "HUT" Approval Request Type
    And The User deselect the checkbox of "Toxicology/Clinical Safety Full/HUT*" Approver on Request Approvals tab
    ...
    And The User selects "RMC Admin*" Approver on Request Approvals tab
    And The User selects "External Approval Acquired " value for "Toxicology/Clinical Safety Full/HUT*" Approver on Request Approvals tab
