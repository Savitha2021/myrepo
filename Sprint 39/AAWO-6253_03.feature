...
Feature: Formula HUT Request (Formula Custom WF)
  ...
  @AAWO-7430 @FullAutomation @Sprint-39
  Scenario Outline: Test Formula HUT Request (Formula Custom WF) 03
    ...
    Then The User selects "None" radio button for "Toxicology/Clinical Safety" field under "HUT" subsection on Request Approvals tab 
