...
Feature: Formula Custom Workflow - Formula Workflow page, Information under Completed Reviews Tab when Any Approver is not selected when any workflow is launched
	...
	@AAWO-7574 @FullAutomation @Sprint-38
	Scenario Outline: Test Formula Custom Workflow - Formula Workflow page, Information under Completed Reviews Tab when Any Approver is not selected when any workflow is launched 01
		...
		And The User deselect the checkbox of the "Toxicology/Clinical Safety Full/HUT*" Approver on the Request Approval tab 
		...
		And The User deselect the checkbox of the "APAC Regulatory Full *" Approver on the Request Approval tab 
		And The User selects "External Approval Acquired " option for "APAC Regulatory Full *" Approver on the Request Approval tab 
		And The User deselect the checkbox of the "EMEA Regulatory Preliminary/HUT " Approver on the Request Approval tab 
		And The User selects "External Approval Acquired " option for "EMEA Regulatory Preliminary/HUT *" Approver on the Request Approval tab 
		And The User deselect the checkbox of the "Legal*" Approver on the Request Approval tab 
		And The User selects "External Approval Acquired " option for "Legal*" Approver on the Request Approval tab 
		And The User deselect the checkbox of the "Environmental Assessment*" Approver on the Request Approval tab 
		And The User selects "External Approval Acquired " option for "Environmental Assessment*" Approver on the Request Approval tab 
		...
		And The User verify the information for "Toxicology/Clinical Safety Full/HUT" Approval in the Completed Reviews tab 
